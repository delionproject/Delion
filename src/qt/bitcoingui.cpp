                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Delion Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Delion address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and delion: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDELION"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Delion Core"), this);
    aboutAction->setStatusTip(tr("Show information about Delion Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Delion"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Delion addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Delion addresses"));
    ...
    openAction->setStatusTip(tr("Open a Delion: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Delion Core help message to get a list with possible Delion command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Delion Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Delion network", "", count));
}
...
{
    QString strTitle = tr("Delion Core"); // default title
...
/** Creates context menu, its actions, and delions up all the relevant signals for mouse events. */

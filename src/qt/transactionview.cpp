                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Delion from zDELION"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDELION"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDELION));

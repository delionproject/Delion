...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Delion to zDELION");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zDELION");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Delion from zDELION");
    case TransactionRecord::ZerocoinSpend_Change_zDELION:
        return tr("Minted Change as zDELION from zDELION Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zDELION to Delion");

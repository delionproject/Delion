...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Delion Core");
    ...
    QString copyrightTextDelion = QChar(0xA9) +QString(tr("2018-Hell Freezes")) + QString(tr("The Delion Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextDelion);

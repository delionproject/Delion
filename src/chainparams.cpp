...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(1, uint256("0x000000927ce9eb83a354c968467c67264705f1a841bc1fc39f175c11edecc8c6"));
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // Delion: 1.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // Delion: 10 minutes (Slow launch - Block 288)
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Delion new blockchain is here";
...
public:
    CTestNetParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000001c7c4ad26b9c250a67fc7b5cec228b9b1018b9738c2f3ad78e283046f50"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Delion addresses start with 'x' or 'y'
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51436;
        assert(hashGenesisBlock == uint256("0x00000777dd623fc92db4e5cd994110415777960f430f1cd04923b0b8072c3942"));
